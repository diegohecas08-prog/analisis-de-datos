...
if page == "Dashboard":
    ...
    with t1:
        ...
        cb.plotly_chart(px.area(data.groupby(data['date'].dt.year)['show_id'].count().reset_index(), x='date', y='show_id', title="Evolución", color_discrete_sequence=['#E50914']), use_container_width=True)
