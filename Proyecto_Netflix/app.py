...
if page == "Dashboard":
    ...
    with t1:
        ...
        cb.plotly_chart(px.area(data.groupby(data['year'].dt.year)['show_id'].count().reset_index(), x='año', y='evolucion por año', title="Evolución", color_discrete_sequence=['darkblue']), use_container_width=True)
