...
if page == "Dashboard":
    ...
    with t1:
        ...
        cb.plotly_chart(px.area(data.groupby(data['año'].dt.year)['evolucion'].count().reset_index(), x='año', y='evolucion', title="Evolución", color_discrete_sequence=['#E50914']), use_container_width=True)
